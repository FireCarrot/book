...
def book(driver, wait=10):
    driver.execute_script("window.location.href = 'http://ticket.melon.com/performance/index.htm?prodId=201363'")
...
#    driver.execute_script("selectedBlock(this,'80','3,31','3','층','31','구역','SE0001')")
    driver.execute_script("selectedBlock(this,'81','3,32','3','층','32','구역','SE0001')")
